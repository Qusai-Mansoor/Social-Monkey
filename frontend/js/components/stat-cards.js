...
class StatCards {
    ...
    updateCards(statsData) {
        ...
        if (statCards[0]) {
            ...
            if (valueEl) {
                this.animateValue(valueEl, this.stats.posts, this.formatNumber(statsData.posts || 0));
            }
        }
        ...
        if (statCards[1]) {
            ...
            if (valueEl) {
                this.animateValue(valueEl, this.stats.engagement, this.formatEngagement(statsData.engagement || 0));
            }
        }
